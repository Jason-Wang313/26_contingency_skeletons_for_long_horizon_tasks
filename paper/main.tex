...
\label{tab:topology}
\small
\input{../results/full_scale/tex/table_dependency_topology.tex}
\end{table}
...
\label{tab:economics}
\small
\input{../results/full_scale/tex/table_guard_economics.tex}
\end{table}
...
\small
\input{../results/full_scale/tex/table_guard_reliability.tex}
\end{table}
...
\label{tab:missing}
\small
\input{../results/full_scale/tex/table_missing_coverage.tex}
\end{table}
